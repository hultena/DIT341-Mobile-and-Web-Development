<template>
  ...
  >
    <b-form @submit.stop.prevent='handleSubmit(onSubmit)'>
      ...
      <!-- Allergy checkboxes -->
      <!-- TODO: Figure out how to show old selections via v-model on mount -->
      <b-form-group
...
import AddInstructions from '@/forms/recipes/AddInstructions'
...
export default {
  ...
  computed: {
    ...mapGetters(['loggedInUser', 'selectedRecipe'])
  },

  methods: {
    ...mapActions(['putRecipe']),

    async onSubmit() {
      const message = await this.putRecipe(this.form)
  ...
  created() {
    ...
    this.form.name = this.selectedRecipe.name
    this.form.category = this.selectedRecipe.category
    this.form.description = this.selectedRecipe.description
    this.form.ingredients = this.selectedRecipe.ingredients
    this.form.allergies = this.selectedRecipe.allergies
    this.form.dietaryRestrictions = this.selectedRecipe.dietaryRestrictions
    this.form.instructions = this.selectedRecipe.instructions
  }
}
</script>
